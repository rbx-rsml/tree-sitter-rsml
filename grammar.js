...
module.exports = grammar({
    ...
    rules: {
        ...
        _definition_no_macro: function ($) { return choice($.static_token_assignment, $.token_assignment, $.rule_scope, $.derive_declaration, $.tween_declaration, $._definition_scope_body); },
        ...
        tween_declaration: function ($) { return seq('@tween', $.identifier, optional($.datatype), $.semi_colon); },
        ...
        rule_scope_body: function ($) { return choice($.rule_scope, $.priority_declaration, $.name_declaration, $.tween_declaration, $.property_assignment, $.token_assignment, $.static_token_assignment, $._definition_scope_body); },
        datatype: function ($) { return choice($.color, $.tuple, $.number, $.string, $.enum, $.rbx_asset, $.rbx_content, $.reference, $.operation); },
